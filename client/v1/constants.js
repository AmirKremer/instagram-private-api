...
const ROUTES = {
    ...
    taggedFeed: 'usertags/<%= id %>/feed/<%= maxId ? ("?max_id=" + maxId) : "" %>',
    ...
    suggestedUsers: 'discover/chaining/?target_id=<%= target_id %>',
    ...
    userHighlights: 'highlights/<%= id %>/highlights_tray/<%= maxId ? ("?max_id=" + maxId) : "" %>',
    recentActivity: 'news/inbox/'
};
